...
/decl/hierarchy/skill/clerical
	name = "Clerical"
	ID	 = "3"
	default_max = SKILL_MAX

/decl/hierarchy/skill/culinary
	name = "Culinary"
	ID	 = "4"
	default_max = SKILL_MAX
...
/decl/hierarchy/skill/physical/combat
	ID = "2"
	name = "Close Combat"
...
/decl/hierarchy/skill/physical/combat/get_cost(var/level)
	switch(level)
		if(SKILL_BASIC)
			return difficulty
...
/decl/hierarchy/skill/physical/EVA
	ID = "3"
...
/decl/hierarchy/skill/general/construction
	ID = "2"
	name = "Construction"
...
/decl/hierarchy/skill/general/electrical
	ID = "4"
...
/decl/hierarchy/skill/general/pilot/mech
	ID = "6"
	...
	prerequisites = list(SKILL_PILOT = SKILL_BASIC)
	difficulty = SKILL_AVERAGE
	default_max = SKILL_BASIC

// Category: Clerical

/decl/hierarchy/skill/clerical/bureaucracy
	ID = "1"
	name = "Bureaucracy"
...
/decl/hierarchy/skill/clerical/bureaucracy/update_special_effects(mob/mob, level)
	mob.remove_language(LANGUAGE_LEGALESE)
	if(level >= SKILL_EXPERT)
		mob.add_language(LANGUAGE_LEGALESE)

/decl/hierarchy/skill/clerical/finance
	ID = "2"
	name = "Finance"
...
/decl/hierarchy/skill/engineering/engines/get_cost(var/level)
	switch(level)
		if(SKILL_BASIC)
			return difficulty
		if(SKILL_ADEPT)
...
/decl/hierarchy/skill/medsci/medical
	ID = "1"
	name = "Medicine"
...
/decl/hierarchy/skill/medsci/anatomy
	ID = "3"
	name = "Anatomy"
...
/decl/hierarchy/skill/medsci/chemistry
	ID = "5"
	name = "Chemistry"
