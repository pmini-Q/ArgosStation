...
/decl/closet_appearance/secure_closet/argos/security
	extra_decals = list(
		"stripe_vertical_mid_full" = COLOR_NT_RED,
		"security" = COLOR_NT_RED
	)

/decl/closet_appearance/secure_closet/argos/security/forensics
	extra_decals = list(
		"stripe_vertical_mid_full" = COLOR_NT_RED,
		"forensics" = COLOR_NT_RED
	)

/decl/closet_appearance/secure_closet/argos/security/warden
	extra_decals = list(
...
/decl/closet_appearance/secure_closet/argos/security/hos
	extra_decals = list(
		"stripe_vertical_left_full" = COLOR_NT_RED,
...
/obj/structure/closet/secure_closet/argos/security
	name = "security officer's locker"
	req_access = list(access_brig)
	closet_appearance = /decl/closet_appearance/secure_closet/argos/security

/obj/structure/closet/secure_closet/argos/security/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/argos/hos
	name = "head of security's locker"
	req_access = list(access_hos)
	closet_appearance = /decl/closet_appearance/secure_closet/argos/security/hos

/obj/structure/closet/secure_closet/argos/hos/WillContain()
	return list(
		/obj/item/clothing/suit/armor/pcarrier/medium/command/security,
		/obj/item/clothing/head/helmet/solgov/command,
		/obj/item/device/radio/headset/heads/argoshos,
...
/obj/structure/closet/secure_closet/argos/warden
	name = "warden's locker"
	req_access = list(access_armory)
	closet_appearance = /decl/closet_appearance/secure_closet/argos/security/warden
...
/obj/structure/closet/secure_closet/forensics
	...
	closet_appearance = /decl/closet_appearance/secure_closet/argos/security/forensics
