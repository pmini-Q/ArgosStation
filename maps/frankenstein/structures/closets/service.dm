 ...
 * Argos Service
 */
/decl/closet_appearance/secure_closet/argos/hydroponics
	extra_decals = list(
...
/obj/structure/closet/chefcloset_argos
	name = "chef's closet"
	desc = "It's a storage unit for foodservice equipment."
	closet_appearance = /decl/closet_appearance/wardrobe/black

/obj/structure/closet/chefcloset_argos/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/hydroponics_argos //done so that it has no access reqs
	name = "hydroponics locker"
	req_access = list()
	closet_appearance = /decl/closet_appearance/secure_closet/argos/hydroponics

/obj/structure/closet/secure_closet/hydroponics_argos/WillContain()
	return list(
...
/obj/structure/closet/jcloset_argos
	name = "custodial closet"
	desc = "It's a storage unit for janitorial equipment."
	closet_appearance = /decl/closet_appearance/wardrobe/mixed

/obj/structure/closet/jcloset_argos/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/bar_argos
	name = "bar locker"
	desc = "It's a storage unit for bar equipment."
	req_access = list(access_bar)

/obj/structure/closet/secure_closet/bar_argos/WillContain()
	return list(
