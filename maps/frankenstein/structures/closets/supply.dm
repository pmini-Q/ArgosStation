 ...
 * Argos Supply
 */
/decl/closet_appearance/secure_closet/argos/cargo
	extra_decals = list(
		"stripe_vertical_mid_full" = COLOR_BEASTY_BROWN,
		"cargo_upper" = COLOR_BEASTY_BROWN
	)

/decl/closet_appearance/secure_closet/argos/cargo/worker
	extra_decals = list(
...
/decl/closet_appearance/secure_closet/argos/cargo/quartermaster
	extra_decals = list(
...
/obj/structure/closet/secure_closet/decktech
	...
	closet_appearance = /decl/closet_appearance/secure_closet/argos/cargo/worker
...
/obj/structure/closet/secure_closet/argos/quartermaster
	name = "quartermaster's locker"
	req_access = list(access_qm)
	closet_appearance = /decl/closet_appearance/secure_closet/argos/cargo/quartermaster

/obj/structure/closet/secure_closet/argos/quartermaster/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/prospector
	...
	closet_appearance = /decl/closet_appearance/secure_closet/argos/cargo
