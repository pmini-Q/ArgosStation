/obj/item/clothing/suit/armor/vest/solgov
	name = "\improper Sol-Ceti Axis armored vest"
	desc = "A synthetic armor vest. This one is marked with the crest of the Sol-Ceti Axis."
	icon_state = "solvest"
	icon = 'maps/torch/icons/obj/obj_suit_solgov.dmi'
	item_icons = list(slot_wear_suit_str = 'maps/torch/icons/mob/onmob_suit_solgov.dmi')

/obj/item/clothing/suit/storage/vest/solgov
	name = "\improper Sol-Ceti Axis heavy armored vest"
...
/obj/item/clothing/suit/storage/vest/solgov/command
	...
	desc = "A synthetic armor vest with Sol-Ceti Axis printed in gold lettering on the chest. This one has added webbing and ballistic plates."
