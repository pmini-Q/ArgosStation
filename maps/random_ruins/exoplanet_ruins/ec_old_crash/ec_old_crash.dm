...
/obj/item/weapon/disk/astrodata
	...
	desc = "A disk with a wealth of astronomical data recorded. Someone out there would probably pay a decent price for this."
...
/obj/item/weapon/paper/ecrashlog/Initialize()
	. = ..()
	var/shipname = "SEV [pick("Magellan", "Gagarin", "Drake", "Horizon", "Aurora")]"
	var/decl/cultural_info/S = SSculture.get_culture(CULTURE_HUMAN_EARTH)
	var/new_info = {"
	I am Lieutenant Hao Ru, captain of [shipname], of the Solar Expeditionary Corps.<br>
	...
	I am Lieutenant Hao Ru, captain of [shipname] of the Solar Expeditionary Corps. I will be joining my crew in cryo now.<br>
